...
describe('Acesso a página da Wikipedia', () => {
    ...
    it('Pesquisa por Brasil verificando o resultado da busca', () => {
        ...
        cy.get(loc.INPUT_BUSCA).should('be.visible').type('Brasil'+'{downarrow}', { delay: 250 })
        //Realiza o clique no botão de lupa e a busca pelo termo Brasil
        cy.get(loc.LUPA_BTN).click()
