const locators = {
        CARROSSEL_DE_SLIDES: '.wp-block-uagb-post-carousel',
        IMG_ULTIMASDOBLOG: '.uagb-post__image-position-top > :nth-child(2)',
        IMG_TDSOBREEMPRESTIMO: '.uagb-block-be168cfe > :nth-child(2) > .uagb-post__image',
        CAMPO_EMAIL: '.uagb-forms-email-input',
        RODAPE: '.site-footer-primary-section-2',
